...
public class ItemRequestControllerTest {
    ...
    private ItemRequest createItemRequestExample() {
        User user = new User(2L, "test", "test@test.ru");
    ...
    void getItemRequest() throws Exception {
        ...
        Long userId = itemRequest.getRequester().getId();
        ItemRequestDtoWithItemList itemRequestDtoWithItems = itemRequestMapper.toItemRequestDtoWithItems(itemRequest);
    ...
    void getAllItemRequests() throws Exception {
        ItemRequest itemRequest = createItemRequestExample();
        Long userId = itemRequest.getRequester().getId();
        List<ItemRequestDtoWithItemList> itemRequestDtoWithItemsList = new ArrayList<>();
        ItemRequestDtoWithItemList itemRequestDtoWithItems = itemRequestMapper.toItemRequestDtoWithItems(itemRequest);
